...
$rolUsuario = "A"; // El rol del usuario por defecto
$correoUsuario = "AdminJose@gmail.com"; // El correo del usuario por defecto
$nombreUsuario = "Jose Andres"; // El nombre del usuario por defecto
$telefonoUsuario = "75304361"; // El teléfono del usuario por defecto
$passwordUsuario = password_hash("JoseRodriguez", PASSWORD_DEFAULT); // La contraseña del usuario por defecto (reemplaza "contraseña" con la contraseña real)

$insertUsuario = "INSERT INTO usuarios (rol, correo, nombre, telefono, password) 
VALUES ('$rolUsuario', '$correoUsuario', '$nombreUsuario', '$telefonoUsuario', '$passwordUsuario')";

$conexion->exec($insertUsuario);

array_push($resultados, "Usuario por defecto insertado correctamente");
